...
use crate::services::grpc::{KeplrLoginRequest, LoginResponse, RefreshAccessTokenRequest};
...
impl AuthService {
    ...
    pub async fn login(&mut self, keplr_response: String) -> Result<LoginResponse, Status> {
