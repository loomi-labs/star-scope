...
func HasProject() predicate.Channel {
...
func HasProjectWith(preds ...predicate.Project) predicate.Channel {
	return predicate.Channel(func(s *sql.Selector) {
		step := newProjectStep()
...
func HasEventListeners() predicate.Channel {
	return predicate.Channel(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEventListenersWith(preds ...predicate.EventListener) predicate.Channel {
	return predicate.Channel(func(s *sql.Selector) {
