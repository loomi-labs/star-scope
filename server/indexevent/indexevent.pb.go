...
type TxEvent struct {
	...
	ChainPath     string                 `protobuf:"bytes,1,opt,name=chain_path,json=chainPath,proto3" json:"chain_path,omitempty"`
...
func (x *TxEvent) GetChainPath() string {
	if x != nil {
		return x.ChainPath
	}
	return ""
...
var file_indexevent_indexevent_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x68,
	0x61, 0x69, 0x6e, 0x50, 0x61, 0x74, 0x68, 0x12, 0x25, 0x0a, 0x0e, 0x77, 0x61, 0x6c, 0x6c, 0x65,
