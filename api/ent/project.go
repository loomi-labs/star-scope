...
func (e ProjectEdges) ChannelsOrErr() ([]*Channel, error) {
	if e.loadedTypes[0] {
...
// QueryChannels queries the "channels" edge of the Project entity.
func (pr *Project) QueryChannels() *ChannelQuery {
	return NewProjectClient(pr.config).QueryChannels(pr)
}
